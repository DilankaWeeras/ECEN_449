...
set_property PACKAGE_PIN K19 [get_ports {btn_sw_tri_i[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {btn_sw_tri_i[6]}]

set_property PACKAGE_PIN Y16 [get_ports {btn_sw_tri_i[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {btn_sw_tri_i[7]}]